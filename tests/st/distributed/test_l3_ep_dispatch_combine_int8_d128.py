...
def _build_ep_dispatch_combine_program():
    ...
    @pl.program
    class EpDispatchCombineInt8D128:
        # ----------------------------------------------------------------
    ...
    return EpDispatchCombineInt8D128
...
class TestL3EpDispatchCombineInt8D128Int8:
    """L3 distributed runtime: 2-rank EP dispatch + local_expert + combine, INT8 x."""

    def test_ep_dispatch_combine_int8_d128(self, test_config, device_ids):
        if len(device_ids) < 2:
