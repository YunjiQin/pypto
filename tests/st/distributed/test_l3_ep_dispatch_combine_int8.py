...
class TestL3EpDispatchCombineInt8Int8:
    """L3 distributed runtime: 2-rank EP dispatch + local_expert + combine, INT8 x."""

    def test_ep_dispatch_combine_int8(self, test_config, device_ids):
        if len(device_ids) < 2:
